...
class DatePickers extends FilterWidgetBase {
  ...
  public function exposedFormAlter(array &$form, FormStateInterface $form_state) {
    ...
    $is_single_date = isset($form[$field_id]['#type'])
      && 'textfield' == $form[$field_id]['#type'];
